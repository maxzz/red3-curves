    ...
    return (
        <>
            ...
            <div className="App h-screen flex flex-col items-center text-yellow-900">
                ...
                <div className="m-4 hidden lg:flex flex-col items-center text-sm">
                    ...
                    <p>Based on <a
                        className="underline" href="https://bl.ocks.org/d3indepth/raw/b6d4845973089bc1012dec1674d3aff8" target="_blank" rel="noopener">D3 Curve Explorer</a> from <a
                            className="underline" href="https://www.d3indepth.com/shapes" target="_blank" rel="noopener">D3 in Depth</a> book by <a
                                className="underline" href="http://animateddata.co.uk" target="_blank">Peter Cook</a>
                    </p>
