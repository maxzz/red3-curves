...
export const CURVEINFO: CurveInfo[] = [
    ...
    { name: 'curveBundle (ß=0.5)', curve: d3.curveBundle.beta(0.5), grpIdx: 0, lineStyle: 1, group: false, active: true,                info: 'Same as curveBasis with the addition of a paramter ß which determines how close to a straight line the curve is.' },
    ...
    { name: 'curveCardinal (tension=0)', curve: d3.curveCardinal.tension(0), grpIdx: 1, lineStyle: 0, group: true, active: true,        info: "Interpolates the points using a cubic B-spline. A tension parameter determines how 'taut' the curve is. As tension approaches 1 the segments become linear." },
    ...
    { name: 'curveCatmullRom (α=0)', curve: d3.curveCatmullRom.alpha(0), grpIdx: 2, lineStyle: 0, group: true, active: false,           info: 'Similar to curveCardinal (tension=0) but with a parameter α that determines the parameterisation used to interpolate the points. If α=0 the parameterisation is uniform.' },
    ...
    { name: 'curveCatmullRom (α=1)', curve: d3.curveCatmullRom.alpha(1), grpIdx: 2, lineStyle: 2, group: false, active: true,           info: 'Similar to curveCardinal (tension=0) but with a parameter α that determines the parameterisation used to interpolate the points. If α=1 the parameterisation is chordal.' },
    ...
    { name: 'curveLinear', curve: d3.curveLinear, grpIdx: 6, lineStyle: 0, group: true, active: false,                                  info: 'Interpolates the points using linear segments.' },
